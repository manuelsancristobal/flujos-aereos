...
try:
    url_aero_global = (
        "https://data.opendatasoft.com/api/explore/v2.1/catalog/datasets/airports-code-icao/exports/csv?limit=-1"
    )
...
historico = historico.sort_values("Año").astype(
    {"Pasajeros_Nacionales": int, "Pasajeros_Internacionales": int, "Pasajeros_Total": int}
)
